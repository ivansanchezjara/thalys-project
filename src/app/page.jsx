...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="relative bg-gray-50 py-16 md:py-24 border-b border-gray-100 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 relative z-10">
          <div className="flex-1 space-y-6 text-center md:text-left">
            ...
            <p className="text-lg text-gray-600 max-w-lg mx-auto md:mx-0 font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <Link
                href="/about"
                className="bg-white border border-gray-200 text-gray-700 px-8 py-3.5 rounded-full font-semibold hover:bg-gray-50 transition-all text-center"
              >
                Sobre Nosotros
              </Link>
            </div>
